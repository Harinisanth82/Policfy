...
const Login = () => {
    ...
    if (token) {
      const verifyToken = async () => {
        ...
        try {
          ...
          alert(err.message || "Google Login Verification Failed");
          navigate('/login', { replace: true });
        } finally {
          setLoading(false);
        }
  ...
  const handleGoogleLogin = () => {
    ...
    // Dynamically calculate the backend redirect URL based on your current API environment
          ...
          <Row>
            <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
              <Checkbox
                ...
                sx={{ padding: 0, color: theme.text_secondary, '&.Mui-checked': { color: theme.text_primary } }}
              />
